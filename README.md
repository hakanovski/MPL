...
git clone https://github.com/hknyrgnc/mpl.git
...
🚀 Usage
To cast a spell (run a script), pass the .ms file to the main interpreter:
python -m src.main examples/hybrid_oracle.ms

Example Console Output:
🌙 MPL Interpreter Initialized.
📚 Magi Loaded.
